...
import ibis
from trivena_framework.tests.utils import FrappeTestCase

from trivena_insights.insights.doctype.insights_table_v3 import insights_table_v3 as table_module
...
class TestUserPermissionColumns(FrappeTestCase):
    ...
    def test_no_columns_when_doctype_is_not_readable(self):
        ...
        trivena.set_user("Guest")
        try:
            self.assertFalse(trivena.has_permission("Role", "read"))
