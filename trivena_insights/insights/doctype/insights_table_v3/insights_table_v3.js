	...
	refresh: function (frm) {
		...
		frm.add_custom_button(__("Statistics"), function () {
			frm.call("get_stats").then((r) => {
				...
				const fmt_dt = (val) =>
					val ? trivena.datetime.str_to_user(val) : "—";
