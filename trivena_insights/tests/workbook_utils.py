...
from trivena_framework.utils import set_request

from trivena_insights.api import get_doc as get_public_doc
from trivena_insights.api import run_doc_method as run_public_doc_method
from trivena_insights.api.workbooks import create_folder, move_item_to_folder
...
def get_workbook(name):
    ...
    for field in ("folders", "queries", "charts", "dashboards"):
        workbook[field] = trivena.parse_json(workbook.get(field)) or []
    return workbook
