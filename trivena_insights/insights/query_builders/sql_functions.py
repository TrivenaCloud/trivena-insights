...
from trivena_framework.utils.data import (
    add_to_date,
    get_date_str,
    get_first_day,
    get_last_day,
...
class ColumnFormatter:
    ...
    def format_date(cls, format, column: Column):
        ...
        if format == "Week":
            ...
            dialect = trivena.flags._current_query_dialect
...
def get_week_start_day_index():
    day = trivena.db.get_single_value("Insights Settings", "week_starts_on") or "Monday"
...
def get_fiscal_year_start_date():
    fiscal_year_start = trivena.db.get_single_value(
