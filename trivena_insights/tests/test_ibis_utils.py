...
from trivena_insights.insights.doctype.insights_data_source_v3.ibis_utils import IbisQueryBuilder
...
class TestIbisQueryBuilderGranularity(InsightsIntegrationTestCase):
    def make_query_doc(self, operations):
        return trivena._dict(
            ...
            operations=trivena.as_json(operations),
        )
...
""",
    ...
    def test_summary_query_rejects_calendar_buckets_for_time_columns(self):
        ...
        with self.assertRaises(trivena.ValidationError) as exc:
